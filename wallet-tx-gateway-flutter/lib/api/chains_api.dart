...
class ChainsApi {
  ...
  Future<Response> apiV1ChainsGetWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/chains';
  ...
  ///
  /// Returns all supported chains with CAIP-2 identifiers and metadata.
  Future<ApiV1ChainsGet200Response?> apiV1ChainsGet() async {
    final response = await apiV1ChainsGetWithHttpInfo();
